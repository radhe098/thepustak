      ...
      <div className=' bg-slate-800 w-3/12 mt-2 m-6 rounded-3xl p-4 flex-1' >
        ...
        <label htmlFor="text" className="block text-sm font-medium leading-6 text-gray-900">
          ...
          <div className=' text-white flex justify-around mt-7'>
            <h1 className=" text-white text-xl  ">Already Registered ? </h1> <button onClick={()=>navigateTo('/login')} className="border text-lg border-black w-36 h-8 hover:bg-indigo-500 bg-indigo-600 rounded-lg  ">Login</button>
          </div>
        </div>
      </div>  
      </div>
